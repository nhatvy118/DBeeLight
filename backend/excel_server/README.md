...
| `EXCEL_FILES_PATH` | `/data/uploads` | thư mục chứa `.xlsx` — **phải là shared volume** với backend |

## Lưu ý quan trọng (storage §8)

Tool Excel nhận **đường dẫn tương đối** so với `EXCEL_FILES_PATH`. backend ghi file

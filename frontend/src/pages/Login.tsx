...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Email/password login: placeholder (có thể kết nối backend sau)
    if (!email.trim() || !password.trim()) return;
    window.alert('Đăng nhập bằng email chưa được hỗ trợ. Vui lòng dùng "Log in with Google".');
  };
    ...
    <div className="flex flex-col min-h-full bg-white">
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 text-center">Log in</h1>
